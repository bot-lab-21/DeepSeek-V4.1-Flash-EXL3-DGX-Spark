...
class DeepseekV4FlashInferMLAAttention(_B12xWoProjMixin, DeepseekV4Attention):
...
class DeepseekV4FlashInferSM120Attention(_B12xWoProjMixin, DeepseekV4Attention):
    ...
    def __init__(self, vllm_config: VllmConfig, *args, **kwargs) -> None:
        ...
        self._woproj_setup(vllm_config)
